...
public @interface AuthorizedFeignClient {
    ...
    Class<?>[] configuration() default com.cross.config.OAuth2UserClientFeignConfiguration.class;
    ...
    /**
     * Fallback class for the specified Feign client interfaces. The fallback class must
     * implement the interfaces annotated by this annotation and be a valid Spring bean.
     * @return the fallback class for the specified Feign client interfaces.
     */
