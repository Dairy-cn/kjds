...
public class DeviceUtil {
    ...
    private static String agentKey = "user-agent";
    ...
    private static String[] mobileUserAgents = new String[] { "Nokia", // 诺基亚，有山寨机也写这个的，总还算是手机，Mozilla/5.0
        ...
        "Windows CE", // Windows CE，Mozilla/4.0 MSIE 6.0
    ...
    public static boolean isMobileDevice(HttpServletRequest request) {
        ...
        String userAgent = request.getHeader(agentKey);
    ...
    public static boolean isIOSDevice(HttpServletRequest request) {
        ...
        String userAgent = request.getHeader(agentKey);
        for (int i = 0; userAgent != null && !"".equals(userAgent.trim()) && i < ios_sys.length; i++) {
    ...
    public static boolean isWeChat(HttpServletRequest request) {
        String userAgent = request.getHeader(agentKey).toLowerCase();
    ...
    public static boolean isAlipay(HttpServletRequest request){
        String userAgent = request.getHeader(agentKey).toLowerCase();
        return userAgent == null || userAgent.indexOf("alipay") == -1 ? false : true;
    }
}
