...
public class RestPage<T> implements Page<T> , Serializable {
    ...
    private static final long serialVersionUID = -5261108023468389192L;

    private PageImpl<T> pageDelegate = new PageImpl<>(new ArrayList<>());
    ...
    public void setPageable(long totalElements) {
        pageDelegate = new PageImpl<>(getContent(), null, totalElements);
    }
