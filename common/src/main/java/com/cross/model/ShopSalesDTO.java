 ...
 */
public class ShopSalesDTO implements Serializable {
    ...
    public ShopSalesDTO(Long volume, Double sellFee, Long count) {
        this.volume = null != volume ? volume : 0L;
        this.sellFee = null != sellFee ? sellFee.floatValue() : 0F;
        this.count = null != count ? count : 0L;
    }

    public ShopSalesDTO(String shopName, Float price, Long salesVolume, Double sellFee, Long count) {
    ...
    public ShopSalesDTO(Long salesVolume) {
        this.salesVolume = null != salesVolume ? salesVolume.intValue() : 0;
    }
    ...
    public boolean equals(Object o) {
        ...
        ShopSalesDTO shopSalesDTO = (ShopSalesDTO) o;
        if (shopSalesDTO.getId() == null || getId() == null) {
            return false;
        }
        return Objects.equals(getId(), shopSalesDTO.getId());
    }
