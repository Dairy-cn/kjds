...
public class WXPay {
    ...
    public Map<String, String> fillRequestData1(Map<String, String> reqData) throws Exception {
    ...
    public boolean isPayResultNotifySignatureValid(Map<String, String> reqData) throws Exception {
        ...
        log.info("signTypeInData---"+signTypeInData);
        WXPayConstants.SignType signType;
        if (signTypeInData == null) {
            signType = WXPayConstants.SignType.HMACSHA256;
            log.info("signTypeInData == null---HMACSHA256");
        }
        else {
            signTypeInData = signTypeInData.trim();
            if (signTypeInData.length() == 0) {
                signType = WXPayConstants.SignType.MD5;
                log.info("signTypeInData.length() == 0---MD5");
            }
            else if (WXPayConstants.MD5.equals(signTypeInData)) {
                signType = WXPayConstants.SignType.MD5;
                log.info("WXPayConstants.MD5.equals(signTypeInData)---MD5");
            }
            else if (WXPayConstants.HMACSHA256.equals(signTypeInData)) {
                signType = WXPayConstants.SignType.HMACSHA256;
                log.info("WXPayConstants.HMACSHA256.equals(signTypeInData)---HMACSHA256");
            }
            else {
    ...
    public Map<String, String> transfer(Map<String, String> reqData, int connectTimeoutMs, int readTimeoutMs) throws Exception {
        String url = WXPayConstants.Transfer_URL_Suffix;
        String respXml = this.requestWithCert(url, this.fillRequestData1(reqData), connectTimeoutMs, readTimeoutMs);
        return WXPayUtil.xmlToMap(respXml);
    }
