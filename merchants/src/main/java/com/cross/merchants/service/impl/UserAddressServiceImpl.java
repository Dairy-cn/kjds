...
import com.cross.merchants.repository.UserAddressRepository;
import com.cross.merchants.service.UserAddressService;
import com.cross.merchants.service.dto.UserAddressDTO;
import com.cross.merchants.service.mapper.UserAddressMapper;
...
public class UserAddressServiceImpl implements UserAddressService {
    ...
    public List<UserAddressDTO> findAllByUserId(Long userId) {
        return userAddressMapper.toDto(userAddressRepository.findAllByUserIdAndDeleteFlagNotOrderByDefaultFlagDescIdDesc(userId,true));
    }
